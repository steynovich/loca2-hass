...
from custom_components.loca2.api import Loca2AuthError, Loca2ConnectionError, Loca2ApiError
...
class TestValidateInput:
    ...
    async def test_validate_input_connection_error(self, hass: HomeAssistant):
        ...
        with patch("custom_components.loca2.config_flow.Loca2ApiClient") as mock_client_class:
            ...
            mock_client = AsyncMock()
            mock_client_class.return_value = mock_client
            mock_client.authenticate.side_effect = Loca2ConnectionError("Cannot connect")
...
class TestLoca2ConfigFlow:
    ...
    async def test_form_success(self):
        ...
        with patch("custom_components.loca2.config_flow.validate_input") as mock_validate:
            ...
            flow.async_create_entry = AsyncMock(return_value={"type": FlowResultType.CREATE_ENTRY})
...
class TestLoca2OptionsFlow:
    ...
    async def test_options_form_success(self):
        ...
        flow = Loca2OptionsFlowHandler(mock_entry)
        flow.async_create_entry = AsyncMock(return_value={"type": FlowResultType.CREATE_ENTRY})
        flow._validate_options = AsyncMock(return_value={
    ...
    async def test_options_validation_error(self):
        ...
        flow.async_show_form = AsyncMock(return_value={"type": FlowResultType.FORM})
        flow._get_available_devices = AsyncMock()
        flow._validate_options = AsyncMock(side_effect=vol.Invalid("scan_interval error"))
    ...
    async def test_options_get_available_devices_success(self):
        ...
        # Create mock devices
        mock_devices = [
            Loca2Device(id="device1", name="Device 1", device_type="tracker", 
                       battery_level=80, last_seen=datetime.now()),
            Loca2Device(id="device2", name="Device 2", device_type="tracker", 
                       battery_level=60, last_seen=datetime.now()),
        ]
        ...
        with patch("custom_components.loca2.config_flow.Loca2ApiClient") as mock_client_class:
            ...
            assert flow._available_devices == {"device1": "Device 1", "device2": "Device 2"}
    ...
    async def test_options_validate_scan_interval(self):
        ...
        from custom_components.loca2.config_flow import Loca2OptionsFlowHandler
        from custom_components.loca2.const import MIN_SCAN_INTERVAL, MAX_SCAN_INTERVAL
        import voluptuous as vol
