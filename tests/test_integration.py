...
class TestIntegrationSetupFlow:
    ...
    async def test_complete_setup_flow(self, hass: HomeAssistant, mock_config_entry, mock_api_client):
    ...
    async def test_setup_with_invalid_credentials(self, hass: HomeAssistant, mock_config_entry):
    ...
    async def test_setup_with_connection_error(self, hass: HomeAssistant, mock_config_entry):
...
class TestAPIIntegrationWithMockServer:
    ...
    async def test_api_rate_limiting(self, hass: HomeAssistant, mock_config_entry):
        ...
        mock_client = Mock()
        mock_client.test_connection = AsyncMock(side_effect=Exception("Rate limit exceeded"))
    ...
    async def test_api_error_recovery(self, mock_api_client):
        ...
        # Simulate API error
        mock_api_client.get_devices.side_effect = Loca2ConnectionError("Connection failed")
...
class TestIntegrationReloadAndUnload:
    ...
    async def test_integration_reload(self, hass: HomeAssistant, mock_server, mock_config_entry_data):
    ...
    async def test_integration_unload_cleanup(self, hass: HomeAssistant, mock_server, mock_config_entry_data):
    ...
    async def test_unload_with_platform_failure(self, hass: HomeAssistant, mock_server, mock_config_entry_data):
    ...
    async def test_options_update_triggers_reload(self, hass: HomeAssistant, mock_server, mock_config_entry_data):
...
class TestEndToEndIntegration:
    ...
    async def test_full_integration_lifecycle(self, hass: HomeAssistant, mock_server, mock_config_entry_data):
    ...
    async def test_integration_with_config_options(self, hass: HomeAssistant, mock_server, mock_config_entry_data):
        ...
        with patch("custom_components.loca2.Loca2ApiClient") as mock_client_class, \
             patch("custom_components.loca2.Loca2DataUpdateCoordinator") as mock_coord_class:
