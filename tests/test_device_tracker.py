...
class TestLoca2DeviceTracker:
    ...
    def test_latitude_with_valid_location(
        self, mock_coordinator, mock_device, mock_location
    ):
    ...
    def test_longitude_with_valid_location(
        self, mock_coordinator, mock_device, mock_location
    ):
    ...
    def test_location_accuracy_with_accuracy(
        self, mock_coordinator, mock_device, mock_location
    ):
    ...
    def test_state_home_online_with_location(
        self, mock_coordinator, mock_device, mock_location
    ):
    ...
    def test_state_not_home_online_without_location(
    ...
    def test_extra_state_attributes_full(
        self, mock_coordinator, mock_device, mock_location
    ):
    ...
    @pytest.mark.asyncio
    async def test_handle_coordinator_update_name_change(
        self, mock_coordinator, mock_device
    ):
        ...
        tracker.async_write_ha_state = (
            MagicMock()
        )  # Mock this to avoid entity ID issues
    ...
    @pytest.mark.asyncio
    async def test_async_update_location_success(
        self, mock_coordinator, mock_device, mock_location
    ):
