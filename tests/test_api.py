...
class TestLoca2Device:
    ...
    def test_post_init_validation_invalid_battery(self):
        ...
        with pytest.raises(ValueError, match="Battery level must be an integer between 0 and 100"):
            Loca2Device(
                id="device123",
                name="Test Device",
                device_type="tracker",
...
class TestLoca2Location:
    ...
    def test_validation_missing_coordinates(self):
        ...
        with pytest.raises(ValueError, match="Location data must contain 'latitude' and 'longitude' fields"):
...
class TestLoca2ApiClient:
    ...
    async def test_custom_session(self):
        ...
        client = Loca2ApiClient(
            "key", "https://api.example.com", session=mock_session
        )
